...
// DNS record types and the CDN zone they live in (DNSRecordType, DNSRecord,
// CDNZone, ...) moved to cdn.go: DNS records are not a standalone resource
// for Parspack, they are scoped to a CDN zone (AGENTS.md 4.1, 4.5, issue #19).
