...
یونیت‌تست شده‌اند، `go test ./...` سبز است، و سرور هم از باینری ساده و هم از داکر بالا می‌آید. برای دیدن آنچه
هنوز کم است بخش [وضعیت فعلی پروژه](#sec-14) را ببینید.
...
- **Skill کاربر نهایی فقط ابزارهای فاز ۱ را پوشش می‌داد.** حالا هر ۱۴۷ ابزار را مستند می‌کند، به‌همراه
